...
// struct AccessInfo {
//     AccessInfo(bool isRead, pid_t tid, char* var, ADDR addr, int32_t varSize, int32_t loopID, int32_t parentLoopID)
//         : isRead(isRead), tid(tid), var(var), addr(addr), size(varSize), loopID(loopID), parentLoopID(parentLoopID) {}
//     AccessInfo() : tid(-1), addr(0), size(0), loopID(-1), parentLoopID(-1) {}
...
//     int32_t size;
//     int32_t loopID;
//     int32_t parentLoopID;
// };

// typedef MPSCQueue<AccessInfo> AccessInfoQueue;
