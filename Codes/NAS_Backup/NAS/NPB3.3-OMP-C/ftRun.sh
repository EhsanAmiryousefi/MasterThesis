...
mv ft.S.bc ft/
cd ft/
/home/amiryousefi/llvmTemp/build/bin/opt -S -dpomp < ft.S.bc > ft.S_DpOMPInstrumented.bc
...
/home/amiryousefi/llvmTemp/build/bin/clang++ -fopenmp  ft.S_DpOMPInstrumented.bc  /home/amiryousefi/llvmTemp/llvm/projects/compiler-rt/lib/DiscoPoPOpenMP/iFunctions-final.ll -o ft.S_DpOMPInstrumented

./ft.S_DpOMPInstrumented