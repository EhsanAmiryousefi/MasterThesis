...
mv sp.S.bc sp/
cd sp/
/home/amiryousefi/llvmTemp/build/bin/opt -S -dpomp < sp.S.bc > sp.S_DpOMPInstrumented.bc
...
/home/amiryousefi/llvmTemp/build/bin/clang++ -fopenmp  sp.S_DpOMPInstrumented.bc  /home/amiryousefi/llvmTemp/llvm/projects/compiler-rt/lib/DiscoPoPOpenMP/iFunctions-final.ll -o sp.S_DpOMPInstrumented
