 ...
 *
 *
 *  Created by Rohit Atre on 22/11/15.
 *  
 *  Revised for CU v3 by 
 *
 */
...
void DiscoPoPOpenMP::setupCallbacks() {
	...
	CUInstInitialize = cast<Function>(ThisModule->getOrInsertFunction("__DiscoPoPOpenMPInitialize", 
    	Void,
    	CharPtr,
    	(Type*)0));

    CUInstFinalize = cast<Function>(ThisModule->getOrInsertFunction("__DiscoPoPOpenMPFinalize", 
    	Void,
    	(Type*)0));
    ...
    CUInstWrite = cast<Function>(ThisModule->getOrInsertFunction("__DiscoPoPOpenMPWrite",
            Void,
            Int32,
            Int32,
            Int64,
    ...
    CUInstCallBefore = cast<Function>(ThisModule->getOrInsertFunction("__DiscoPoPOpenMPCallBefore",
            Void,
            Int32,
            (Type*)0));

    CUInstCallAfter = cast<Function>(ThisModule->getOrInsertFunction("__DiscoPoPOpenMPCallAfter",
            Void,
            Int32,
            Int32,
            (Type*)0));
